package com.references.common.jwt.service;

import com.references.common.jwt.model.JwtConstants;
...
public class JwtTokenProvider {
    ...
    public JwtTokenVO generateToken(Authentication authentication) {
        // 권한 가져오기
